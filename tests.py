...
class TestTicTacToe(unittest.TestCase):
    ...
    def test_mouse_agent_requires_display(self):
...
class TestDisplay(unittest.TestCase):
    ...
    def test_console_display_outcome(self, _):
    ...
    def test_console_display_message(self):
    ...
    def test_tkinter_display_initialization(self):
    ...
    def test_tkinter_display_update(self):
    ...
    def test_tkinter_display_outcome(self):
    ...
    def test_tkinter_display_message(self):
    ...
    def test_tkinter_wait_for_action(self):
    ...
    def test_tkinter_click_handler(self):
    ...
    def test_tkinter_display_quit_on_outcome(self):
